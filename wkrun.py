...
print batch_num
train_iter=wkiter('../jetimgnumtest.root',['data'],['softmax_label'],batch_size=batch_num,begin=_beg,end=_mid)
...
model.fit(train_iter,
                ...
                batch_end_callback =
                [mx.callback.ProgressBar(train_iter.totalnum()),mx.callback.Speedometer(batch_num,train_iter.totalnum()-1)],
                epoch_end_callback=mx.callback.do_checkpoint('save/jetwcheck/jetwcheck_'+args.network+'_'+str(start.date())),
