...
batch_num=1000
train_iter=niter('../jetimgnum.root',['data'],['softmax_label'],batch_size=batch_num,begin=0,end=0.6)
test_iter=niter('../jetimgnum.root',['data'],['softmax_label'],batch_size=batch_num,begin=0.6,end=1.)
...
# train with the same 
sym,arg_params,aux_params=mx.model.load_checkpoint("save/jeticheck_2017-08-02",7)
